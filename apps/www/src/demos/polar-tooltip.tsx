...
/** Default polar tooltip — snaps to the nearest category spoke. */
export default function PolarTooltipDemo() {
  return (
    <Chart data={radarSkills} inset={24}>
      ...
      <PolarLayout outerRadius="75%">
        <PolarAngleAxis dataKey="skill">
          ...
          <PolarCrosshair stroke-dasharray="4,4" class="stroke-violet-400/70" />
