import { Area, Axis, AxisGrid, AxisLabel, AxisLine, Chart, Legend, Line } from "peculiar-charts";
...
export default function StackedArea() {
  return (
    <Chart data={sales}>
      ...
      <Line dataKey="coffee" stackId="s" class="text-blue-600" color="#2563eb" stroke-width={2} />
      <Line dataKey="tea" stackId="s" class="text-emerald-600" color="#059669" stroke-width={2} />
