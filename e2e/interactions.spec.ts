...
test.describe('Chart interactions', () => {
  ...
  test('dots-events: clicking a dot shows the picked value', async ({
    page,
  }) => {
  ...
  test('syncId: hovering one chart syncs tooltip to the other', async ({
    page,
  }) => {
  ...
  test('brush: dragging a handle updates the visible range', async ({
    page,
  }) => {
