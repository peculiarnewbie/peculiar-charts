...
const Grid = (props: GridProps) => {
  ...
  const x = (tick: any) => (axisContext.axis() === "x" ? pos(tick) : chartContext.getInset("left"));
  const y = (tick: any) => (axisContext.axis() === "x" ? chartContext.getInset("top") : pos(tick));
  const x2 = (tick: any) =>
    axisContext.axis() === "x" ? pos(tick) : chartContext.width() - chartContext.getInset("right");
  const y2 = (tick: any) =>
    axisContext.axis() === "x"
